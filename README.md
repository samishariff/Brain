...
**Brain for Windows preview 1.0.3.18 is available** from the [Brain website](https://samishariff.github.io/Brain/). Read the [preview notes](https://samishariff.github.io/Brain/release-notes.html) before installing. Physical microphones, live calls, device changes and sleep/wake behavior remain unverified for this preview.
