...
(() => {
  ...
  const ASSETS = {
    mac: {
      focus: {
        ...
        transcript:{ file:'mac-transcript-detail.png', alt:'A readable crop of the actual Mac live transcript.', caption:'Live transcript. Enlarged from the same native capture.' },
      ...
      outcome: {
        chat:{ file:'mac-actions.png', alt:'The actual Mac Actions list: the to-dos filed from a seeded sample meeting, with a due date and an overdue item.', caption:'Actual Mac app · seeded sample meeting ' },
        summary:{ file:'mac-review-summary.png', alt:'The actual Mac Review screen with a seeded sample meeting: attendees, an editable summary, decisions, and open questions.', caption:'Actual Mac app · seeded sample meeting ' },
        actions:{ file:'mac-review-actions.png', alt:'The actual Mac approved meeting record with its summary, decisions, and commitments marked To do or Waiting.', caption:'Actual Mac app · seeded sample meeting ' }
      }
    },
    windows: {
      focus: {
        ...
        transcript:{ file:'windows-transcript-detail.png', alt:'A readable crop of the actual Windows live transcript.', caption:'Live transcript. Enlarged from the same native capture.' },
        assistant:{ file:'windows-assistant-detail.png', alt:'A readable crop of the actual Windows meeting assistant.', caption:'Meeting assistant. Enlarged from the same native capture.' }
      },
      speak: {
        full:{ file:'windows-speak.png', alt:'The actual Windows Brain Speak screen.', label:' Focus on dictation history', status:'Showing the complete captured Speak screen.' },
        detail:{ file:'windows-speak-detail.png', alt:'Enlarged actual Windows Speak dictation history.', label:' Show the complete Speak window', status:'Showing the captured dictation history detail.' }
      },
      outcome: {
        chat:{ file:'meeting-chat-1568.webp', alt:'Windows meeting review with a generated sample meeting and an actual local-model answer.', caption:'Actual Windows app · generated sample meeting and local-model answer ' },
  ...
  function entrance() {
    const target = panel(workspace);
    if (!target) return;
    if (focus !== 'workspace') { renderFocus('workspace'); return; }
  ...
  /* Saved meeting: three captures of the same seeded meeting, chosen by the shared buttons. */
